...
const quote_performance_test_1 = require("./quote-performance.test");
const load_test_1 = require("./load-test");
const tokenCacheService_1 = require("../../src/services/tokenCacheService");
const fs = require("fs");
...
async function runAllPerformanceTests() {
    ...
    try {
        const quoteTester = new quote_performance_test_1.QuotePerformanceTest();
    ...
    try {
        // Clear cache first
        tokenCacheService_1.tokenCacheService.clearCache();
        // Test cold start
        const coldStartTime = Date.now();
        await tokenCacheService_1.tokenCacheService.getTokens();
        ...
        // Get cache stats
        const cacheStats = tokenCacheService_1.tokenCacheService.getStats();
        const hitRate = tokenCacheService_1.tokenCacheService.getCacheHitRate();
    ...
    try {
        const loadTester = new load_test_1.LoadTester({

...
// Integration tests config - use Node.js environment for server-side code
const integrationJestConfig = {
  // Use Node.js environment for integration tests (not jsdom)
  testEnvironment: 'node',
  
  // Setup files after environment is set up
  setupFilesAfterEnv: ['<rootDir>/jest.setup.integration.js'],
  
  // Setup files to add polyfills before environment
  ...
  // Test path patterns - only integration tests
  testMatch: [
